...
public class ExcelUtils {
    ...
    //how do you get the last row number? Index starts at 0.
    public int rowCount() {
        return workSheet.getLastRowNum()+1; //adding 1 to get the actual count //getPhysicalNumberOfRows()
    }
    ...
    //When you enter the row and column number, add the value
